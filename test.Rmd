...
<<<<<<< HEAD
```{r}
salary_batting <- salary_batting %>%
  filter(PA >= 100)
```


```{r}
lm_mod <- lm(salary ~ H, HR, data = salary_batting)
summary(lm_mod)
```
```{r}
lm_mod_prd <- salary_batting %>% add_predictions(lm_mod)
lm_mod_prd
```
...
<<<<<<< HEAD
=======
>>>>>>> ee063489bbdf03b92d60072960b192ed3dd4a8b6
